...
// payments), and MediAssist AI routes are documented with @openapi blocks
// so far (Phases 2-8). Each later phase should add its own blocks to its
// route files as those endpoints are built, rather than documenting
